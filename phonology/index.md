...
> **補足説明**  
> 参照言語であるフランス語においては、鼻母音か否かは意味を区別する上で非常に重要な音韻的特徴です。  
> しかしながら、どの鼻母音（/ɑ̃/, /ɛ̃/, /œ̃/）であるかを厳密に区別することは、日常会話や実際のコミュニケーションにおいてはそれほど重要ではなく、  
> しばしば区別されずに理解されています。  
> つまり、鼻母音か否かの対立は意味を決定づけますが、鼻母音の種類の違いは文脈や慣習によって容易に補完され、区別しなくても通じることが多いのです。  
>
> この言語実態を踏まえ、Fonelでは /ɑ̃/, /ɛ̃/, /œ̃/ の鼻母音を区別せずに表記できる汎用鼻母音文字「ą」を導入し、表記の簡略化と柔軟性を図っています。  
> これにより、発音の揺れや方言差、話者間のバリエーションを包括し、学習や運用の負担を軽減することが可能になります。  
>
> 一方、/ɔ̃/（オン）については発音が比較的明瞭で意味区別に影響しやすいため、汎用文字の適用対象から外しています。
